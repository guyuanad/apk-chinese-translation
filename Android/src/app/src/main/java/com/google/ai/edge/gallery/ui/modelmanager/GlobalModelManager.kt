...
fun GlobalModelManager(
  ...
  if (showImportingDialog) {
    selectedLocalModelFileUri.value?.let { uri ->
      selectedImportedModelInfo.value?.let { info ->
        val modelImportedSuccessfully = stringResource(R.string.model_imported_successfully)
        ModelImportingDialog(
          ...
          onDone = {
            ...
            scope.launch { snackbarHostState.showSnackbar(modelImportedSuccessfully) }
          },
        )
      }
    }
  ...
  if (showUnsupportedFileTypeDialog) {
    AlertDialog(
      ...
      text = { Text(stringResource(R.string.supported_file_type)) },
      confirmButton = {
  ...
  if (showUnsupportedWebModelDialog) {
    AlertDialog(
      ...
      text = { Text(stringResource(R.string.web_only_model)) },
      confirmButton = {
