...
class DownloadWorker(context: Context, params: WorkerParameters) :
    ...
    if (!channelCreated) {
      ...
      val channel =
        NotificationChannel(
            ...
            context.getString(R.string.model_downloading_channel_name),
            // Make it silent.
            NotificationManager.IMPORTANCE_LOW,
          )
          .apply { description = context.getString(R.string.model_downloading_channel_description) }
  ...
  private fun createForegroundInfo(progress: Int, modelName: String? = null): ForegroundInfo {
    ...
    var title = applicationContext.getString(R.string.downloading_model_title)
    if (modelName != null) {
      title = applicationContext.getString(R.string.downloading_model_title_with_name, modelName)
    }
