...
To create an event, you must follow these exact steps:
...
To modify or delete an existing event, use the `update-calendar-event` or `delete-calendar-event` skills respectively. You will need the `event_id` from the calendar events list.
